  ...
  <div class="d-flex justify-content-center">
    <div class="card card-input-no-meteran p-2">
      <div class="card-body">
        ...
        <form action="{{route('tagihan')}}" method="POST" id="formTagihan">
          @csrf
          <div class="form-row">
            <div class="col col-10">
              <input class="form-control form-control-lg" name="id_pelanggan" id="inputIDPelanggan" type="text" placeholder="ID Pelanggan" autocomplete="off">
