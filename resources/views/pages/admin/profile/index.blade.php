  ...
  <div class="container w-50">
    ...
    <div class="card card-profile mx-auto">
      <div class="card-body text-center">
        ...
        <!-- icon user edit -->
        <a href="{{route('admin.profile.edit', \Auth::id())}}" class="text-decoration-none" data-toggle="tooltip" data-placement="top" title="Edit Profile">
        ...
        <div class="card-title">
          <div class="font-weight-bold mt-3">Aulia El Ihza Fariz Rafiqi</div>
          <div>Administrator</div>
          <div>2021-02-16</div>
        </div>
        <a href="#"data-toggle="tooltip" data-placement="top" title="auliaelihza@gmail.com">
